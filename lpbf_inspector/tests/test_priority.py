import unittest
from priority import priority_value, with_priority, priority_text
from persistence import page_after


class PriorityTests(unittest.TestCase):
    def test_readable_landmarks_and_monotonic_components(self):
        self.assertEqual(priority_value(2,3),50)
        self.assertEqual(priority_value(6,6),70.7)
        ...
        self.assertIn('50.0 / 100',priority_text(scored))
